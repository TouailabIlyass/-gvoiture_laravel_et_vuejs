    ...
    <div class="container" id="ctn" style="margin-top:-60px">
        ...
        <div class="container" style="border: 1px solid #000">
            ...
            <div class="infos">
                ...
                <div class="row" style="padding-bottom:4px" v-if="ReservationFromStore.client.pieceIdentite === 'cin'">
                    <div class="col-md-4 col-xs-4"><span>N de C.I.N:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>{{ReservationFromStore.client.numPiece}}</span></div>
                    <div class="col-md-4 col-xs-4"><span>Valable jusqu'au:</span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ReservationFromStore.client.dateDelivrPiece}}</span></div>
                </div>
                <div class="row"  style="padding-bottom:4px" v-if="ReservationFromStore.client.pieceIdentite === 'passport'">
                 ...
                 <div class="row" style="padding:4px 0">
                    <div class="col-md-4 col-xs-4">
                        <span>N d'entree:</span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ReservationFromStore.conducteur.numPermis}}</span>
                    </div>
                </div>
                <div class="row" style="padding:4px 0">
               ...
               <div class="row" style="padding:4px 0"><div class="col-md-4 col-xs-4"><span>Adresse:</span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ReservationFromStore.client.addresse}}</span></div></div>
            </div><!-- information client -->
    
            <!-- information conducteur -->
            <div class="infos">
                <h5 style="border-bottom: 4px solid #000">INFORMATION CONDUCTEUR</h5>
                ...
                <div class="row" style="padding-bottom:4px" v-if="ReservationFromStore.conducteur.pieceIdentite === 'cin'">
                ...
                <div class="row" style="padding-bottom:4px"  v-else-if="ReservationFromStore.conducteur.pieceIdentite === 'passport'">
                 ...
                 <div class="row" style="padding-bottom:4px" v-else>
                    <div class="col-md-4 col-xs-4"><span>N de C.I.N:</span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ReservationFromStore.conducteur.numPiece}}</span></div>
                    <div class="col-md-4 col-xs-4"><span>Valable jusqu'au:</span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ReservationFromStore.conducteur.dateDelivrPiece}}</span></div>
                </div>
                <div class="row" style="padding:4px 0">
             ...
             <!-- information voiture -->
             <div class="infos">
                <h5 style="border-bottom: 4px solid #000">INFORMATION SUR LA VOITURE</h5>
